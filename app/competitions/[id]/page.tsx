...
export default function EventDetailPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Banner */}
      <section className="min-h-[60vh] bg-cover bg-center py-20 flex items-center relative"
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-10 space-y-6">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#EA4A3E]/20">
                  ...
                  <Link href="/register">
                    <Button className="w-full bg-[#EA4A3E] hover:bg-[#D03F34] text-white py-4 text-lg font-semibold rounded-xl">
                      Register Now
                    </Button>
                  </Link>
