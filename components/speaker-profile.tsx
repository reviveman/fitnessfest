...
export function SpeakerProfile({ speaker }: SpeakerProfileProps) {
  return (
    <div className="flex flex-col bg-gray-200 p-18 items-center md:flex-row gap-8">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="relative w-[220px] h-[220px] group">
          <div
            className={`absolute inset-0 rounded-full border-2 ${speaker.color} border-solid transition-all duration-300 group-hover:border-dashed animate-spin`}
          />
